...
export const metadata: Metadata = {
  ...
  description:
    "Broadcast a directional signal on Base with title, intensity, and a short market-style explanation.",
};

const baseAppId =
  process.env.NEXT_PUBLIC_BASE_APP_ID ?? "6a05edd07ce26b40a2802bca";
